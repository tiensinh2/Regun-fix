...
class SwinClassifier(pl.LightningModule):
    """Minimal Lightning wrapper for torchvision Swin."""

    @classmethod
    def build(cls, cfg: DictConfig) -> "SwinClassifier":
        return cls(cfg.model)

    @classmethod
    def load(cls, checkpoint_path: str, strict: bool = True) -> "SwinClassifier":
    ...
    def __init__(self, cfg):
        ...
        ctor, weights_enum = _SWINS[cfg.model.name.lower()]
